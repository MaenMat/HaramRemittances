    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HaramCurrencies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HaramCustomers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HaramRemittances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HaramRemittances_HaramCurrencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "HaramCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HaramRemittances_HaramCustomers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "HaramCustomers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HaramRemittances_HaramCustomers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "HaramCustomers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "HaramRemittanceStatuses",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StatusDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    RemittanceClassId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HaramRemittanceStatuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HaramRemittanceStatuses_HaramRemittances_RemittanceClassId",
                        column: x => x.RemittanceClassId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HaramCurrencies_Name",
                table: "HaramCurrencies",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HaramCurrencies_Symbol",
                table: "HaramCurrencies",
                column: "Symbol",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HaramCustomers_FirstName_LastName_FatherName_MotherName",
                table: "HaramCustomers",
                columns: new[] { "FirstName", "LastName", "FatherName", "MotherName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HaramRemittances_CurrencyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HaramRemittances_ReceiverId",
                table: "HaramRemittances",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_HaramRemittances_SenderId",
                table: "HaramRemittances",
                column: "SenderId");
